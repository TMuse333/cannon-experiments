  ...
  return new Promise((resolve, reject) => {
    loader.load(modelPath, (gltf) => {
      ...
      if (!geometry.attributes || !geometry.attributes.position) {
        reject(new Error('Invalid geometry. Unable to find position attribute.'));
        return;
      }
      ...
      const cannonShape = new CANNON.Trimesh(
        ...
        geometry.index ? geometry.index.array : undefined, // Provide the face indices if available
      );
