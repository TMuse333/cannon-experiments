...
import { controlRocketThrottle, launchRocket } from './rocketControls';
import { isWKeyDown } from './rocketControls';
...
export function controlRocket(cannonBody) {
  if (isWKeyDown) {
    // Use the throttle setting to calculate the impulse
    const throttleMultiplier = controlRocketThrottle();
