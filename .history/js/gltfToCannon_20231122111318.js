...
gltfLoader.load(gltfPath, (gltf) => {
  ...
  // Adjust the initial position on the y-axis
  object3D.position.y = 5; // Set your desired initial y-axis position
  ...
  camera.position.z = 20; // Adjust the initial zoom level
  ...
  const cannonBody = new CANNON.Body({
    ...
    shape: shape,
    position: new CANNON.Vec3(offset.x, offset.y + 5, offset.z), // Adjust the initial position on the y-axis
