...
export function getThrustVector(rocketQuaternion) {
  ...
  takeoffImpulse.x = takeoffImpulse.x +(forwardDirection.x * takeoffImpulse.y);
  takeoffImpulse.y =takeoffImpulse. (forwardDirection.y * takeoffImpulse.y);
  takeoffImpulse.z = takeoffImpulse.z + (forwardDirection.z * takeoffImpulse.y);
